    ...
    return (
        <>
            <div className='nav flex h-[70px] bg-white h-[80px] justify-between border-1 border-gray-200'>
                <div className="flex justify-center items-center text-[25px] flex-[0.45] bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent font-[600] hover:cursor-pointer" onClick={() => {window.location.href = '/'}}>finTrack<span className='text-[60px] mt-[-15px]'>.</span></div>
